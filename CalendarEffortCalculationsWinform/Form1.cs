...
namespace CalendarEffortCalculationsWinform
{
    public partial class Form1 : Form
    {
        ...
        {
            Constants.AbnormalSheetName = Setvalue(abNormalBox, Constants.AbnormalSheetName, Constants.DefaultAbnormalSheetName);
            Constants.OTSheetName = Setvalue(otBox, Constants.OTSheetName, Constants.DefaultOTSheetName);
            Constants.TMSSheetName = Setvalue(tmsBox, Constants.TMSSheetName, Constants.DefaultTMSSheetName);
            Constants.CalendarSheetName = Setvalue(calendarBox, Constants.CalendarSheetName, Constants.DefaultCalendarSheetName);
            try
            {
        ...
        private string Setvalue(System.Windows.Forms.TextBox textBox, string value, string defaultValue)
        {
        ...
        private void nameOfAbnormalBox_TextChanged(object sender, EventArgs e)
        {
        }

        private void nameOfTMSBox_TextChanged(object sender, EventArgs e)
        {
        }

        private void nameOfOTBox_TextChanged(object sender, EventArgs e)
        {
        }

        private void nameOfcalendarBox_TextChanged(object sender, EventArgs e)
        {
